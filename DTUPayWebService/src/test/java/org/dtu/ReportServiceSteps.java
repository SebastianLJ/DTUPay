...
//        Token customerToken = customerService.getTokens(customer.getUserId(), 1).get(0);
//        payment = Payment.create(customerToken, merchant.getUserId().getUuid(), 500);
...
//        assertEquals(payment, customerPayments.get(0));
    ...
    @After
    public void delete() throws InvalidMerchantIdException, PaymentNotFoundException, CustomerNotFoundException, MerchantNotFoundException {
        deleteUsersAndPayment();
    }
